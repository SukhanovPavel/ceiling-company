...
export const PageHeader = () => (
    <nav className="_">
        ...
        <a href={`/потолки`} className="links">Потолки</a>
        <a href={`/окна`} className="links">Окна</a>
        <a href={`/жалюзи`} className="links">Жалюзи</a>
        <a href={`/диллерам`} className="links">Диллерам</a>
        <a href={`/комплектующие`} className="links">Комплектующие</a>
        <a href={`/контакты`} className="links">Контакты</a>
        <img
            style={{height: "70px", position: "fixed", left: "5rem", top: "4rem"}}
        ...
        <button
            ...
            <svg style={{height: "3rem"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
