...
export const PageHeader = ({openCalc}: Props) => (
    <nav className={styles._}>
        <a href={`/`} className={styles.links}>Главная</a>
        <a href={`/потолки`} className={styles.links}>Потолки</a>
        <a href={`/окна`} className={styles.links}>Окна</a>
        <a href={`/жалюзи`} className={styles.links}>Жалюзи</a>
        <a href={`/диллерам`} className={styles.links}>Диллерам</a>
        <a href={`/комплектующие`} className={styles.links}>Комплектующие</a>
        <a href={`/контакты`} className={styles.links}>Контакты</a>
        <img
